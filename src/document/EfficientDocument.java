...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		numSyllables=0;
		int i;
		//System.out.println("tsize is: " +tsize);
		for(i = 0; i < tsize; i ++)
		{
			//w is word iterator
			//s is sentence iterator

			
			if(isWord(tokens.get(i))==true)
			{
				//if isword is true, then it's word
				numWords++;
			...
			else if(isWord(tokens.get(i))==false)
			{
				//if isword is false, then string puncutation, and is a sentence identifier
				numSentences++;
				//System.out.print("THis is token: "+ tokens.get(i)+ ". ");
				//System.out.println("s is:" +s);
			}
		}
		//System.out.println("numsentences is: "+numSentences+" numwords is: "+numWords);
