...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		//cast int to double with local variabes db*...
	    double dbwords = getNumWords();
	    double dbsentences = getNumSentences();
	    double dbsyllables = getNumSyllables();
		
	   double FSObj = 206.835 - (1.015*(dbwords/dbsentences)) - (84.6*(dbsyllables/dbwords));
	   return FSObj;
